import unittest
from pi2md import simple_hash_text, detect_file, download_image
import os
...
class TestPi2md(unittest.TestCase):
    ...
    def test_simple_hash_text2(self):
        to_hash = 'f:\Dropbox\Dropbox\docs\md\notes\Diary\2020\11\78e63c5a-66e1-40d6-adc4-23b4accd219b.jpg'
    ...
    def test_download_image(self):
        ...
        fname = 'https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2115546205,172279996&fm=11&gp=0.jpg'
